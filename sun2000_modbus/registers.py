...
class BatteryEquipmentRegister(Enum):
    ...
    MaximumFeedGridPowerKW = Register(47416, 2, datatypes.DataType.INT32_BE, 1000, "kW", AccessType.RW, None)
    MaximumFeedGridPower = Register(47418, 1, datatypes.DataType.INT16_BE, 10, "%", AccessType.RW, None)
