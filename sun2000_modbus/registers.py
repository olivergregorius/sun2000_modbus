...
class InverterEquipmentRegister(Enum):
    ...
    HardwareVersion = Register(31000, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    REGKEY = Register(31200, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    AuthorizationFunction = Register(35136, 2, datatypes.DataType.BITFIELD32, 1, None, AccessType.RO, None)
    LicenseStatus = Register(35138, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RO, None)
    ...
    LicenseSN = Register(35145, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    RevocationCode = Register(35155, 64, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ModuleStatus4G = Register(35249, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RO, None)
    ...
    IMEI4G = Register(35254, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    PINVerificationStatus4G = Register(35266, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RO, None)
    OriginalModelName = Register(35268, 15, datatypes.DataType.MULTIDATA, 1, None, AccessType.RO, None)
    ...
    ChargeDischargeMode = Register(37006, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RO, None)
    ...
    QUCharacteristicCurveMode = Register(40037, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RW, None)
    QUDispatchTriggerPower = Register(40038, 1, datatypes.DataType.INT16_BE, 1, '%', AccessType.RW, None)
    FixedActivePowerDeratedInKW = Register(40120, 1, datatypes.DataType.UINT16_BE, 1, 'W', AccessType.RW, None)
    ...
    AcivePowerLimit = Register(42405, 2, datatypes.DataType.INT32_BE, 1, 'W', AccessType.RW, None)
    ...
    RemoteChargeDischargeControlMode = Register(47589, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RW, None)
    RemoteControlForChargingAndDischarging = Register(47589, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RW, None)
    ...
    PeakShaving = Register(47954, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RW, None)
    ...
    BackupBoxModel = Register(48089, 1, datatypes.DataType.UINT16_BE, None, None, AccessType.RW, None)
...
class BatteryEquipmentRegister(Enum):
    ...
    MaximumFeedGridPowerInKW = Register(47416, 2, datatypes.DataType.INT32_BE, 1, 'W', AccessType.RW, None)
    ...
    Unit2SN = Register(37700, 10, datatypes.DataType.MULTIDATA, 1, None, AccessType.RO, None)
