...
class InverterEquipmentRegister(Enum):
    Model = Register(30000, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    SN = Register(30015, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    PN = Register(30025, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Alarm1 = Register(32008, 1, datatypes.DataType.BITFIELD16, 1, None, AccessType.RO, None)
    Alarm2 = Register(32009, 1, datatypes.DataType.BITFIELD16, 1, None, AccessType.RO, None)
    Alarm3 = Register(32010, 1, datatypes.DataType.BITFIELD16, 1, None, AccessType.RO, None)
...
class BatteryEquipmentRegister(Enum):
    ...
    Unit1BatteryPack1SN = Register(38200, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit1BatteryPack1FirmwareVersion = Register(38210, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Unit1BatteryPack2SN = Register(38242, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit1BatteryPack2FirmwareVersion = Register(38252, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Unit1BatteryPack3SN = Register(38284, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit1BatteryPack3FirmwareVersion = Register(38294, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Unit2BatteryPack1SN = Register(38326, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit2BatteryPack1FirmwareVersion = Register(38336, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Unit2BatteryPack2SN = Register(38368, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit2BatteryPack2FirmwareVersion = Register(38378, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    Unit2BatteryPack3SN = Register(38410, 10, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    Unit2BatteryPack3FirmwareVersion = Register(38420, 15, datatypes.DataType.STRING, 1, None, AccessType.RO, None)
    ...
    ForcibleChargeDischarge = Register(47100, 1, datatypes.DataType.UINT16_BE, 1, None, AccessType.WO, None)
