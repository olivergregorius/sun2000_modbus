...
class InverterEquipmentRegister(Enum):
    ...
    FixedActivePowerDeratedInKW = Register(40120, 1, datatypes.DataType.UINT16_BE, 1, "kW", AccessType.RW, None)
...
class BatteryEquipmentRegister(Enum):
    ...
    PowerOfChargeFromGrid = Register(47242, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RW, None)
    MaximumPowerOfChargeFromGrid = Register(47244, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RW, None)
    ...
    ForcibleChargePower = Register(47247, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RW, None)
    ForcibleDischargePower = Register(47249, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RW, None)
    ...
    MaximumChargeFromGridPower = Register(47590, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RW, None)
    ...
    Unit1BatteryPack3ChargeDischargeStatus = Register(38317, 2, datatypes.DataType.INT32_BE, 1, "W", AccessType.RO, None)
